...
class TvSeriesRemoteDataSourceImpl implements TvSeriesRemoteDataSource {
  // Reuse the same static constants for the base URL and API key
  ...
  // --- 2. GET POPULAR TV SERIES (Replaces Popular Movies) ---
  @override
  ...
  // --- 3. GET TOP RATED TV SERIES (Replaces Top Rated Movies) ---
  @override
  ...
  // --- 5. GET TV SERIES RECOMMENDATIONS (Replaces Movie Recommendations) ---
  @override
  ...
  // --- 6. SEARCH TV SERIES (Replaces Search Movies) ---
  @override
